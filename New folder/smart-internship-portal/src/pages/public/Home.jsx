...
import { 
  FaUserGraduate, FaUserTie, FaArrowRight, 
        ...
        <div className="home-container hero-grid">
          <div className="hero-content">
            ...
            <div className="hero-buttons">
              <Link to="/student-login" className="btn btn-primary-solid">
                <FaUserGraduate /> Student Login
              </Link>
              <Link to="/faculty-login" className="btn btn-outline-bg">
                <FaUserTie /> Faculty Login <FaArrowRight style={{ marginLeft: '4px' }} />
              </Link>
            </div>
          </div>
