...
function Notification() {
  ...
  return () => { ignore = true; };
    ...
    const markAsRead = async (id) => {
        try {
            await api.put(`/student/notifications/${id}/read`);      // markAsRead
    ...
    const markAllAsRead = async () => {
        try {
            await api.put("/student/notifications/read-all");         // markAllAsRead
            setNotifications((previous) =>
                previous.map((notification) => ({
                    ...notification,
                    read: true,
    ...
    const deleteNotification = async (id) => {
        ...
        try {
            await api.delete(`/student/notifications/${id}`);          // deleteNotification
            setNotifications((previous) =>
